...
namespace ImageBinaryClassificationML.ConsoleApp
{
    public static class ModelBuilder
    {
        ...
        public static void CreateModel(
            ...
            string saveModelZipFilePath)
        {
            // Load Data
            IDataView trainingDataView = mlContext.Data.LoadFromTextFile<ModelInput>(
                path: datasetTsvFilePath,
                hasHeader: true,
                separatorChar: '\t',
                allowQuoting: true,
                allowSparse: false);
            ...
            // Save model
            SaveModel(mlContext, mlModel, saveModelZipFilePath, trainingDataView.Schema);
        }
        ...
        public static double CalculateConfidenceInterval95(
            IEnumerable<double> values)
        {
